   ...
   <table summary="{t}Class name selector{/t}" {$grey}>
    ...
    <tr>
     ...
     <td>{t}Class name{/t}&nbsp;
      ...
      <select name="SelectedClass" title="{t}Choose class name{/t}" style="width:120px;" {$ClassNamesAvailable}size=1 onChange="$('classSelector2').writeAttribute('checked', 'checked');">
